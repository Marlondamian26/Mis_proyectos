...
const translations = {
  ...
  pt: {
    ...
    schedules: 'Horarios',
    siteImages: 'Imagens do Sitio',
    siteImageManagement: 'Gerenciamento de Imagens',
    uploadImage: 'Enviar Imagem',
    noSiteImages: 'Nenhuma imagem.enviada',
    uploadFirstImage: 'Enviar Primeira Imagem',
    imageTitle: 'Titulo',
    imageTitlePlaceholder: 'Digite o titulo da imagem',
    imageDescription: 'Descricao',
    imageDescriptionPlaceholder: 'Digite a descricao da imagem',
    imageType: 'Tipo de Imagem',
    typeHero: 'Imagem Hero (Inicio)',
    typeCarousel: ' imagem do Carrusel',
    typeGallery: 'Galeria',
    displayOrder: 'Ordem de Exibicao',
    imageFile: 'Arquivo de Imagem',
    currentImage: 'Imagem atual',
    newImageSelected: 'Nova imagem selecionada',
    activeImage: 'Imagen ativa',
  ...
  es: {
    ...
    itemActivated: '{type} activado',
    itemDeactivated: '{type} desactivado',
    errorTogglingActive: 'Error al cambiar estado',
